...
(def case-graph
  (d/create-model
    {:actions                     [:create-case
     ...
     :action-possible-conditional [{:action             :get-currently-owned-real-estate
                                   ...
                                   {:action             :know-your-customer
                                    :condition-argument :consent
                                    :condition          (fn [consent]
                                                          (:pep consent))}]}))

(comment (dativity.visualize/visualize case-graph {:layout :fdp}))
...
(deftest conditionally-possible-it
         (testing "When "
                  (as-> {} case
                        (c/add-data case :case-id "100001")
                        (c/add-data case :customer-id "9209041111")
